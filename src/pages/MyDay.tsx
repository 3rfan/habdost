...
export default function MyDay() {
  ...
  return (
    <div className="space-y-6 pb-4">
      ...
      {undoToastInfo && (
        <div className="fixed bottom-20 left-1/2 z-50 flex -translate-x-1/2 items-center gap-3 rounded-lg bg-slate-900 px-4 py-2.5 text-slate-100 shadow-xl border border-slate-700/60 dark:bg-slate-100 dark:text-slate-900 dark:border-slate-300/60 transition-all animate-in fade-in slide-in-from-bottom-3">
